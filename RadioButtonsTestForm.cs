...
namespace RadioButtonsTest
{
    public partial class RadioButtonsTestForm : Form
    {
        ...
        {
            // Display MessageBox and store the value of the Button that user pressed
            DialogResult result = MessageBox.Show("This is your custom MessageBox.", "Custom MessageBox", ButtonType, IconType);

            // Check to see which Button that was pressed in the MessageBox change text displayed accordingly
            switch (result)
            {
